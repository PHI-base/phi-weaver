#!/usr/bin/env python3
"""
smoke_test.py — fresh-checkout sanity check for PHI-Weaver.
...
repo-root autodetection, storage bootstrap, DB schema, offline scripts) and runs the
unit-test suite, all **network-free and with zero pip installs** — the optional deps
...
Usage:
    ...
    python3 scripts/smoke_test.py --quiet    # only the final summary + failures
...
TOOL_DIRS = [
    REPO_ROOT / "scripts",
    REPO_ROOT / "11-CLAUDE-AI",
    REPO_ROOT / "11-CLAUDE-AI" / "db",
]
...
def check_repo_layout():
    ...
    expected = [
        ...
        "scripts/query_uniprot.py", "scripts/validate_ontology_ids.py",
        "skills", "11-CLAUDE-AI/db/phi_canto_sqlite.py",
        "11-CLAUDE-AI/curation_pipeline.py",
    ]
...
def check_imports():
    ...
    import curation_pipeline          # noqa: F401
    import phi_canto_sqlite           # noqa: F401
    import session_logger             # noqa: F401
    import query_uniprot              # noqa: F401
    import validate_ontology_ids      # noqa: F401
...
def check_offline_tooling():
    """The deterministic scripts behave correctly without any network."""
    import validate_ontology_ids as v
...
def check_unit_tests():
    """The bundled unit-test suite passes."""
    proc = subprocess.run(
...
CHECKS = [
    ...
    ("offline scripts", check_offline_tooling),
