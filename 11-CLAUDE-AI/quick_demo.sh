...
echo "      python3 mysql-setup/workflow_helper.py start-session 'Project Name'"
echo ""
echo "   ✅ Complete curation:"
echo "      python3 curation_pipeline.py complete-paper filename.pdf 'Summary'"
echo ""
echo "   📊 Check progress:"
echo "      python3 mysql-setup/daily_curation.py progress"
echo ""

echo "💡 Example workflow:"
echo "   1. python3 curation_pipeline.py auto-process ~/Downloads/paper.pdf"
echo "   2. python3 mysql-setup/workflow_helper.py start-session 'Paper Analysis'"
echo "   3. [Do curation work in PHI-Canto]"
echo "   4. python3 mysql-setup/workflow_helper.py end-session 'Paper Analysis' 'Summary' 3 5 2.0"
