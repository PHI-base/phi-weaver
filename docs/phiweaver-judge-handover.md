...
*Generated 2026-07-09 from the PHI-Weaver vault. Single-file convention
...
| # | Role | Vault path |
| - | ---- | ---------- |
| 1 | Scorecard rubric — the criteria the judge should grade against | `07-Standards/curation-benchmarking/README.md` |
| 2 | Controlled vocabulary (annotation types, topics, evidence) used in examples | `07-Standards/curation-examples/TAGS.md` |
| 3 | Index of the worked examples + PHI-Canto annotation-type coverage | `07-Standards/curation-examples/INDEX.md` |
| 4 | Template showing the shape of a worked curation example | `07-Standards/curation-examples/_TEMPLATE.md` |
| 5 | Ontology reference (PHIPO / PHIDO / GO / BRENDA) conventions | `07-Standards/Ontology-Terms-Reference.md` |
| 6 | How genes/proteins are resolved to UniProtKB accessions | `07-Standards/UniProtKB-Gene-Identification-Guide.md` |
| 7 | Gene/allele naming conventions | `07-Standards/Genetic Nomenclature.md` |
| 8 | Effector curation methodology (gene-for-gene, guard/decoy, recognition) | `07-Standards/Effector-curation-2026-04-15/Curation Methodologies for Pathogen Effector Curation.md` |
| 9 | GO terms conventionally used for gene-for-gene / effector entries | `07-Standards/Effector-curation-2026-04-15/GO-terms used for gene-for-gene-entries.md` |
| 10 | What each curation step is supposed to produce (module registry) | `skills/REGISTRY.md` |
| 11 | WORKED EXAMPLE — gene-for-gene (Fol effectors x tomato I-7) | `07-Standards/curation-examples/PMID26177154-Fol-I7-gene-for-gene.md` |
| 12 | WORKED EXAMPLE — effector physical interaction (PINE1 x PGIP) | `07-Standards/curation-examples/PMID35468894-PINE1-effector-PGIP-physical-interaction.md` |
| 13 | WORKED EXAMPLE — protein-level effect (AvrPi9 x OsRGLG5) | `07-Standards/curation-examples/PMID37177781-AvrPi9-OsRGLG5-protein-level.md` |
| 14 | WORKED EXAMPLE — phosphorylation (creD / RLCK185) | `07-Standards/curation-examples/PMID23498959-creD-RLCK185-phosphorylation.md` |
| 15 | WORKED EXAMPLE — cell-wall stress phenotype (FgKnr4) | `07-Standards/curation-examples/PMID39787257-FgKnr4-cell-wall-stress.md` |

---

<!-- ===== FILE 1/15 :: reference ===== -->
## 1. Scorecard rubric — the criteria the judge should grade against
...
<!-- ===== FILE 2/15 :: reference ===== -->
## 2. Controlled vocabulary (annotation types, topics, evidence) used in examples
...
<!-- ===== FILE 3/15 :: reference ===== -->
## 3. Index of the worked examples + PHI-Canto annotation-type coverage
...
<!-- ===== FILE 4/15 :: reference ===== -->
## 4. Template showing the shape of a worked curation example
...
<!-- ===== FILE 5/15 :: reference ===== -->
## 5. Ontology reference (PHIPO / PHIDO / GO / BRENDA) conventions
...
<!-- ===== FILE 6/15 :: reference ===== -->
## 6. How genes/proteins are resolved to UniProtKB accessions
...
<!-- ===== FILE 7/15 :: reference ===== -->
## 7. Gene/allele naming conventions
...
<!-- ===== FILE 8/15 :: reference ===== -->
## 8. Effector curation methodology (gene-for-gene, guard/decoy, recognition)
...
<!-- ===== FILE 9/15 :: reference ===== -->
## 9. GO terms conventionally used for gene-for-gene / effector entries
...
<!-- ===== FILE 10/15 :: reference ===== -->
## 10. What each curation step is supposed to produce (module registry)
...
<!-- ===== FILE 11/15 :: worked-example ===== -->
## 11. WORKED EXAMPLE — gene-for-gene (Fol effectors x tomato I-7)
...
<!-- ===== FILE 12/15 :: worked-example ===== -->
## 12. WORKED EXAMPLE — effector physical interaction (PINE1 x PGIP)
...
<!-- ===== FILE 13/15 :: worked-example ===== -->
## 13. WORKED EXAMPLE — protein-level effect (AvrPi9 x OsRGLG5)
...
<!-- ===== FILE 14/15 :: worked-example ===== -->
## 14. WORKED EXAMPLE — phosphorylation (creD / RLCK185)
...
<!-- ===== FILE 15/15 :: worked-example ===== -->
## 15. WORKED EXAMPLE — cell-wall stress phenotype (FgKnr4)
