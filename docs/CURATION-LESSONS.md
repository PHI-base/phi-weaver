...
| L6 | 2026-07-15 | paper-review | Hsin-Yun Chang, PMID:42089373 | **Conditions must use the controlled vocabulary (PHI-ECO, prefix `PECO:`):** weaver's free-text conditions (media/temp/duration) won't pass final approval. Treat conditions as advisory until PHI-ECO is vendored (mirror the PHIDO fix). | Source link received (github.com/PHI-base/phi-eco); reference in `07-Standards/Ontology-Terms-Reference.md`; backlog item to vendor PHI-ECO + validate `PECO:` | actionable (link received; vendoring pending) |
